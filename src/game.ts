...
export const ENCOUNTERS: Encounter[] = [
  ...
  { name: 'A Knight in the Mire', place: 'GLASS MARSH', theme: 'marsh', description: 'It leaps where others cannot.', lesson: 'Forks: one knight move can attack two pieces.', enemy: 'Mire Rider', ability: 'Moves like a knight. Each capture costs you 5 crowns.', target: 'e5', pieces: [['g8','k'],['a7','p'],['e5','n'],['e4','p'],['d4','p'],['f4','p'],['d6','p'],['f6','p'],['f7','p'],['g7','p']], bounty: 30 },
  { name: 'The Candle Archive', place: 'EMBER LIBRARY', theme: 'ember', description: 'One unguarded diagonal.', lesson: 'Bishops love open diagonals. Look for a pin on the king.', enemy: 'Lantern Keeper', ability: 'Moves like a bishop. Capturing it restores a Takeback.', target: 'e6', pieces: [['g8','k'],['a7','p'],['e6','b'],['e5','p'],['f5','p'],['f8','r'],['b7','n'],['d5','p'],['g6','p'],['f7','p'],['g7','p']], bounty: 35 },
