  ...
  return <div className={`app theme-${encounter.theme}`}>
    ...
    <div className="layout">
      ...
      <aside className="right-panel">
        ...
        <div className="difficulty-note">{run.stage<2?'Gentle start. Learn the shapes.':run.stage<4?'Defenders coordinate.':'The guard looks ahead.'}</div><label className="difficulty"><span>Enemy</span><select aria-label="Enemy strength" value={run.difficulty} onChange={e=>setRun({...run,difficulty:e.target.value as Difficulty})}><option value="wanderer">Wanderer</option><option value="tactician">Tactician</option></select></label>
      </aside>
