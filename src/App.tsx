  ...
  return <div className={`app theme-${encounter.theme}`}>
    ...
    <div className="layout">
      ...
      <aside className="right-panel">
        ...
        <div className="difficulty-note">{run.stage===0?'First fight. Learn the shapes.':run.stage<4?'Act I. Forks and pins, not a full hunt.':'The guard looks ahead.'}</div><label className="difficulty"><span>Difficulty</span><select aria-label="Difficulty" value={run.difficulty} onChange={e=>setRun({...run,difficulty:e.target.value as Difficulty})}><option value="wanderer">Easy</option><option value="tactician">Hard</option></select></label>
      </aside>
